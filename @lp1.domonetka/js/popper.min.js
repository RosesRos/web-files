!(function (e, t) {
  ...
  function i(e) {
    return 11 === e ? J : 10 === e ? K : J || K;
  }
  function f(e) {
    if (!e) return document.documentElement;
    for (
      var n = i(10) ? document.body : null, o = e.offsetParent || null;
  ...
  function c(e) {
    ...
    return { height: d("Height", t, n, o), width: d("Width", t, n, o) };
  }
  function h(e) {
  ...
  function g(e, n) {
    ...
    return (
      (f && !r ? n.contains(u) : n === u && "BODY" !== u.nodeName) &&
        (v = l(v, n)),
      v
    );
  }
  ...
  function y(e, t, i, f) {
    ...
    if ("viewport" === f) p = v(l, s);
      ...
      "scrollParent" === f
        ...
        : (u = "window" === f ? e.ownerDocument.documentElement : f);
      var d = g(u, l, s);
      if ("HTML" !== u.nodeName || b(l)) p = d;
        ...
        var h = c(e.ownerDocument),
          m = h.height,
          y = h.width;
        (p.top += d.top - d.marginTop),
          (p.bottom = m + d.top),
          (p.left += d.left - d.marginLeft),
          (p.right = y + d.left);
      }
    }
    ...
    return (
      (p.left += E ? i : i.left || 0),
      (p.top += E ? i : i.top || 0),
      (p.right -= E ? i : i.right || 0),
      (p.bottom -= E ? i : i.bottom || 0),
      p
    );
  }
  function E(e) {
  ...
  function M(e, t, n, r) {
    ...
    f.addEventListener(t, n, { passive: !0 }),
      i || M(o(f.parentNode), t, n, r),
      r.push(f);
  }
  function P(e, t, n, r) {
    (n.updateBound = r),
      A(e).addEventListener("resize", n.updateBound, { passive: !0 });
    var i = o(e);
    return (
  ...
  var Y = Math.min,
    ...
    J = G && !(!window.MSInputMethodContext || !document.documentMode),
    K = G && /MSIE 10/.test(navigator.userAgent),
    Q = (function () {
      function e(e, t) {
    ...
    ee = G && /Firefox/i.test(navigator.userAgent),
    te = [
      "auto-start",
      "auto",
      "auto-end",
    ...
    oe = (function () {
      function t(n, o) {
        ...
        (function (e, t) {
          ...
          (this.options = $({}, t.Defaults, i)),
          (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
          (this.reference = n && n.jquery ? n[0] : n),
          (this.popper = o && o.jquery ? o[0] : o),
          (this.options.modifiers = {}),
          Object.keys($({}, t.Defaults.modifiers, i.modifiers)).forEach(
            function (e) {
      ...
      modifiers: {
        ...
        arrow: {
          ...
          fn: function (e, n) {
            ...
            var i = e.placement.split("-")[0],
              ...
              m = p ? "bottom" : "right",
              g = L(r)[l];
            a[m] - g < s[d] && (e.offsets.popper[d] -= s[d] - (a[m] - g)),
              a[d] + g > s[m] && (e.offsets.popper[d] += a[d] + g - s[m]),
            ...
            return (
              (E = z(Y(s[l] - g, E), 0)),
              (e.arrowElement = r),
              (e.offsets.arrow = (Z((o = {}), d, q(E)), Z(o, c, ""), o)),
              e
            );
          },
          element: "[x-arrow]",
        ...
        computeStyle: {
          ...
          fn: function (e, t) {
            ...
            var s,
              a,
              p = void 0 === i ? t.gpuAcceleration : i,
              ...
              })(e, 2 > window.devicePixelRatio || !ee),
