...
$folder_name = isset($path_parts[0]) ? $path_parts[0] : '';
?><html lang="ru">
...
<head>
    ...
    <script type="module">
        if ('serviceWorker' in navigator) { navigator.serviceWorker.register("pwabuilder-sw.js", { scope: './' }); }
    </script>

    <title>ami</title>

    <meta name="apple-mobile-web-app-capable" content="yes">
    <link rel="stylesheet" href="index_files/pwa.css">
...
<body>
                                    ...
                                    <div class="app-comp">
                                        ...
                                        <div class="app-comp__left">
                                            ...
                                            <div class="app-comp__info-wrapper">
                                                ...
                                                <div class="app-comp__logo"><img alt="App icon" src="img/icon.png" width="180" height="180">
                                                </div>
                                                <div class="app-comp__main-info">
                                                    <div class="app-comp__info">
                                                        <div class="app-comp__info-left">
                                                            <div class="app-comp__info-title notranslate">
                                                                ami </div>
                                                            <div class="app-comp__info-subtitle"><span class="notranslate">ami</span>
                                                        ...
                                                        <div class="app-comp__right-wrapper">
                                                            ...
                                                            <div class="app-comp__users-rate">
                                                                <div class="star" data-v-2b76e870=""><span data-v-2b76e870=""><img src="index_files/star-full.png?v=2" alt="" data-v-2b76e870=""></span>
                                                                </div>
                                                                <div class="star" data-v-2b76e870=""><span data-v-2b76e870=""><img src="index_files/star-full.png?v=2" alt="" data-v-2b76e870=""></span>
                                                                </div>
                                                                <div class="star" data-v-2b76e870=""><span data-v-2b76e870=""><img src="index_files/star-full.png?v=2" alt="" data-v-2b76e870=""></span>
                                                    ...
                                                    <div class="app-comp__mobile-info">
                                                        ...
                                                        <div class="app-comp__mobile-info-item">
                                                            <span class="app-comp__mobile-info-icon">
                                                                <div class="app-comp__mobile-info-rate" style="border:0px;">10000</div>
                                                            </span>
                                                    ...
                                                    <div class="app-comp__install-wrapper">
                                                        ...
                                                        <button type="button" id="install_button" class="app-comp__install-button active greenBtn" data-size="12.1 MB" style="background-color: rgb(0, 135, 95);">
                                                            <img src="load.svg?v=1" style="width: 20px;height: 20px;margin-top: 3px;">
                                                        </button>
                                                ...
                                                <div class="app-description" data-v-4c38fcdc="">
                                                    ...
                                                    <div class="app-description__content" data-v-4c38fcdc="">
                                                        <div class="app-description__expand expand size collapsed" id="text" data-v-4c38fcdc="">
                                                            <div id="newText" class="app-description__main-content " data-v-4c38fcdc="">
                                                                
                                                                <p class="newText">NОВЫЕ СЛОТЫ 2024</p>
                                                                <p class="newText">Добро пожаловать в НОВЫЕ СЛОТЫ 2023! ami казино игровые автоматы бесплатно без интернета ждут вас прямо сейчас!</p>
                                                                <p class="newText">★ Потрясающий приветственный ami казино бонус 700.000 Free Spin</p>
                                                                <p class="newText">★ Новые слоты без интернета бесплатно каждую неделю!</p>
                                                                <p class="newText">★ ami казино соревнования с другими игроками онлайн!</p>
                                                                <p class="newText">★ Разнообразные игровые автоматы бесплатно без интернета и каждый имеет свою особенность и уникальную бонусную игру!</p>
                                                                <p class="newText">★ Большие награды для тех, кто заходит в игровые автоматы онлайн каждый день!</p>
                                                                <p class="newText">★ Захватывающие игровые ami казино события не дадут заскучать никому!</p>
                                                                <p class="newText">★ Заходите в казино симулятор каждые 2 часа чтобы прокрутить колесо удачи бесплатно!</p>
                                                                <p class="newText">★ А некоторые слот машины имеют такое количество бесплатных вращений, что, кажется, ваши ami казино барабаны будут вращаться бесконечно!</p>
                                                                <p class="newText">★ Классические слоты без интернета бесплатно и современные игровые автоматы онлайн собраны в одной казино симулятор игре!</p>                                                                
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="score" data-v-3bf2ee4c="">
                                                            ...
                                                            <div class="score__stars" data-v-3bf2ee4c="">
                                                                <div class="star" data-v-2b76e870="" data-v-3bf2ee4c="">
                                                                    <span data-v-2b76e870=""><img src="index_files/star-full-big-green.png?v=21" alt="" data-v-2b76e870=""></span>
                                                                </div>
                                                                <div class="star" data-v-2b76e870="" data-v-3bf2ee4c="">
                                                                    <span data-v-2b76e870=""><img src="index_files/star-full-big-green.png?v=21" alt="" data-v-2b76e870=""></span>
                                                                </div>
                                                                ...
                                                                <div class="star" data-v-2b76e870="" data-v-3bf2ee4c="">
                                                                    <span data-v-2b76e870=""><img src="index_files/star-full-big.png?v=21" alt="" data-v-2b76e870=""></span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div data-v-265dd011="" class="testimotials__comment-info">
                                                            ...
                                                            <div data-v-265dd011="" class="testimotials__user-info-wrapper">
                                                                <div data-v-265dd011="" class="testimotials__user-info-top">
                                                                    ...
                                                                    <div data-v-265dd011="" class="testimotials__rate-stars">
                                                                        <div data-v-2b76e870="" data-v-265dd011="" class="star">
                                                                            <span data-v-2b76e870=""><img data-v-2b76e870="" src="index_files/star-full-big-green-1.png?v2" style="max-width: 12px;"></span>
                                                                        </div>
                                                                        <div data-v-2b76e870="" data-v-265dd011="" class="star">
                                                                            <span data-v-2b76e870=""><img data-v-2b76e870="" src="index_files/star-full-big-green-1.png?v2" style="max-width: 12px;"></span>
                                                                        </div>
                                                                        ...
                                                                        <div data-v-2b76e870="" data-v-265dd011="" class="star">
                                                                            <span data-v-2b76e870=""><img data-v-2b76e870="" src="index_files/star-full-big-1.png?v2" style="max-width: 12px;"></span>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div data-v-265dd011="" class="testimotials__text-ph">
                                                                    <div data-v-265dd011="" class="testimotials__text-visible ">ami классное приложение где на ставках и казино хорошо можно заработать</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div data-v-265dd011="" class="testimotials ">
                                                        <div data-v-265dd011="" class="testimotials__comment-info">
                                                            ...
                                                            <div data-v-265dd011="" class="testimotials__user-info-wrapper">
                                                                ...
                                                                <div data-v-265dd011="" class="testimotials__text-ph">
                                                                    <div data-v-265dd011="" class="testimotials__text-visible ">ami отличное приложение рекомендую всем</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div data-v-265dd011="" class="testimotials ">
                                                        <div data-v-265dd011="" class="testimotials__comment-info">
                                                            ...
                                                            <div data-v-265dd011="" class="testimotials__user-info-wrapper">
                                                                ...
                                                                <div data-v-265dd011="" class="testimotials__text-ph">
                                                                    <div data-v-265dd011="" class="testimotials__text-visible ">ami очень хорошо работает и деньги быстро выводит. Советую всем скатать это приложение</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div data-v-265dd011="" class="testimotials hidden_comment">
                                                        <div data-v-265dd011="" class="testimotials__comment-info">
                                                            ...
                                                            <div data-v-265dd011="" class="testimotials__user-info-wrapper">
                                                                ...
                                                                <div data-v-265dd011="" class="testimotials__text-ph">
                                                                    <div data-v-265dd011="" class="testimotials__text-visible ">Скачала себе отличное приложение онлайн казино ami, хорошие выигрыши, высокие коэффициенты и моментальные выплаты. Супер!!!</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div data-v-265dd011="" class="testimotials hidden_comment">
                                                        <div data-v-265dd011="" class="testimotials__comment-info">
                                                            ...
                                                            <div data-v-265dd011="" class="testimotials__user-info-wrapper">
                                                                ...
                                                                <div data-v-265dd011="" class="testimotials__text-ph">
                                                                    <div data-v-265dd011="" class="testimotials__text-visible ">Отличное приложение ami. Пользуемся с удовольствием. Очень удобно и понятно.. Интересно делать ставки на спорт.. Рекомендую данное приложение...</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script src="npm/js-cookie3.0.1/dist/js.cookie.min.js"></script>
    ...
    setTimeout(function () {
        ...
        const redirectUrl = new URL(`https://<?php echo $domain;?>/<?php echo $folder_name;?>/pwa.php`);
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const baseStartUrl = `https://<?php echo $domain;?>/<?php echo $folder_name;?>/pwa.php?test=1282`;
            ...
            const iconImg = `https://<?php echo $domain;?>/<?php echo $folder_name;?>/img/icon.png`;
