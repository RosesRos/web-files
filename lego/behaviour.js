...
console.log('behaviour.js initiated - v. 1.3b')
//console.log('init ok')
...
document.addEventListener("DOMContentLoaded", (event) => {
  Array.from(document.querySelectorAll('a')).forEach((item, index) => {
    if(item.href.includes('uclick'))
      item.href += `&place=(//${item.tagName})[${index+1}]`;
  })
});
