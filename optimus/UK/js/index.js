document.addEventListener('DOMContentLoaded', function () {
  ...
  function LoaderBox() {
    var loadMoreContent = document.querySelector('div[data-id="158:841"]');
    if (loadMoreContent) {
      loadMoreContent.addEventListener("click", function (e) {
        var loadMoreEl = document.querySelector('div[data-id="158:841"]');
  ...
  let moreText = document.querySelector('div[data-id="I158:842;64:2767;55:886"]');
  function handleDropdownFooter() {
    let e = document.querySelector('.hidden-text'),
    o = document.querySelector('div[data-id="I158:842;64:2767;55:886"]');
