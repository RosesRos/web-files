...
<body>
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <input type="file" id="icon" name="icon" accept=".jpg, .jpeg, .png, .svg"><br>
        <label for="leftScreenshot">1 скриншот (Left):</label>
        <input type="file" id="leftScreenshot" name="leftScreenshot" accept=".jpg, .jpeg, .png, .svg"><br>
        <label for="middleScreenshot">2 скриншот (Middle):</label>
        <input type="file" id="middleScreenshot" name="middleScreenshot" accept=".jpg, .jpeg, .png, .svg"><br>
        <label for="rightScreenshot">3 скриншот (Right):</label>
        <input type="file" id="rightScreenshot" name="rightScreenshot" accept=".jpg, .jpeg, .png, .svg"><br>
