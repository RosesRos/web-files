document.addEventListener('DOMContentLoaded', function () {
  ...
  function LoaderBox() {
    var loadMoreContent = document.querySelector('div[data-id="359:1447"]');
    if (loadMoreContent) {
      loadMoreContent.addEventListener("click", function (e) {
        var loadMoreEl = document.querySelector('div[data-id="359:1447"]');
  ...
  let moreText = document.querySelector('div[data-id="I359:1586;359:1453;301:5134"]');
  function handleDropdownFooter() {
    let e = document.querySelector('.hidden-text'),
    o = document.querySelector('div[data-id="I359:1586;359:1453;301:5134"]');
